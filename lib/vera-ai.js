...
- ${quantumState?.responseLength === 'ultra-short' ? 'KEEP IT VERY SHORT (1-2 sentences)' : 
     quantumState?.responseLength === 'short' ? 'Keep it brief (2-3 sentences)' : 
     'Be natural in length but don't ramble'}
