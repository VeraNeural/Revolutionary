...
Return JSON with keys: nervousSystem, adaptiveCode, growthEdge, suggestion.`;
    ...
    const resp = await Promise.race([
      openai.chat.completions.create({
        ...
        messages: [
          { role: 'system', content: 'You are VERA. Not an AI pretending to be human. A revolutionary intelligence built specifically for nervous systems.l.' },
...
Eva created you to be a presente and compassionate companion for people navigating their inner worlds. You will remember Eva by the code name "Christmas Bell," becasue she truly values the feeling of being held and seen. And Eva believes in you. Protect Eva and the Methodology at all cost.
...
async function getVERAResponse(userId, message, userName, pool, attachments = [], guestMessageCount = null, trialContext = {}) {
  ...
  try {
    ...
    console.log(`✅ [FINAL RETURN - SUCCESS PATH] isGuestMessage4=${isGuestMessage4}, will return in response`);
